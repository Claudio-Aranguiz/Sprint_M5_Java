					...
					<h2 class="mb-4 text-left">Registro de Usuario</h2>
						...
						<div class="mb-3">
							...
							<div class="mb-3" id="clienteFields" style="display: none;">
								...
								<input type="text" id="telefono" name="telefono" class="form-control" placeholder="Ingrese el teléfono del cliente" required><br>
								 <label for="comuna" class="form-label">Comuna</label> 
								 <input type="text" id="comuna" name="comuna" class="form-control" placeholder="Ingrese la comuna del cliente" required><br>
								<br>
							</div>
